...
export default function Home() {
  const handleSubmit = async () => {
    ...
    if (checkoutSession.status === 500) {
        console.error('Error creating checkout session:', checkoutSessionJson.error.message)
        return
    }
  ...
  return (
      <Container maxWidth={"lg"}>
        ...
        <AppBar position="static">
          <Toolbar>
            <Typography variant="h6" style={{flexGrow: 1}}>Flashcard SaaS</Typography> {/* change title */}
            <SignedOut>
          ...
          <Box container spacing={4}>
            ...
            >
              <Grid item xs={12} md={4} px={2}>
                ...
                <Typography>
                  {' '}
                  You can create flashcards with a sleek design that is easy to use.
                </Typography>
              </Grid>
              <Grid item xs={12} md={4} px={2}>
                ...
                <Typography>
                  {' '}
                  For one monthly price, you can create as many flashcards as you want.
                </Typography>
              </Grid>
              <Grid item xs={12} md={4} px={2}>
                ...
                <Typography>
                  {' '}
                  Use the app on any device, including your phone, tablet, or computer.
                </Typography>
              </Grid>
            </Box>
          </Box>
